...
credentials_file_path = os.path.join(settings.BASE_DIR, 'gdrive_service', 'credentials.json')
token_file_path = os.path.join(settings.BASE_DIR, 'gdrive_service', 'token.json')
